  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const presignedUrlResponse = await axios.post(
        'https://obkg1pw61g.execute-api.us-west-2.amazonaws.com/prod/get-mpns-presigned-url',
        requestPayload,
        {
          headers: {
      ...
      setSuccessMessage('File uploaded successfully! Your data has been submitted for processing. You should receive an email once it is processed and downloadable.');
